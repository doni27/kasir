...
public function __construct()
{
	...
	public function tambah(){
		...
		$data = array('title' => 'Tambah stok barang',
			...
			redirect(base_url('investor/transaksi'),'refresh');
		...
		public function keranjang($id_transaksi){
			...
			$data = array('title' => 'Tambah keranjang barang',
							'id' => $id_transaksi,
							'barang' => $barang,	
								'isi' => 'investor/transaksi/keranjang' );
				$this->load->view('investor/layout/wrapper', $data, FALSE);
			}else{
				$i = $this->input;
...
public function cetak(){
   ...
   // Write some HTML code:
           $html = $this->load->view('investor/laporan_penjualan/cetak', $data, true);
...
/* Location: ./application/controllers/investor/User.php */

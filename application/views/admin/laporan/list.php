 ...
 <table class="table table-bordered" id="example1">
 	...
 	<tbody>
 		...
 		<tr>
 			...
 			<td>  <a href="<?= base_url('admin/pembelian/edit/'.$user->no_pembelian)?>" class="btn btn-warning btn-xs "><i class="fa fa-edit"></i> Edit </a>
 				<a href="<?= base_url('admin/pembelian/delete/'.$user->no_pembelian)?>" class="btn btn-danger btn-xs " onclick="return comfirm('yakin ingin menghapus data ini')"><i class="fa fa-trash-o"></i> Delete </a>
 			  </td>
